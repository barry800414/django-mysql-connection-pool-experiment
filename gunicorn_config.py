...
"""
An attempt to emulate uWSGI’s uwsgi.worker_id() that ensures that I have worker IDs
from 1…--workers which is useful in logging and instrumentation where changing PIDs are annoying.

Source: https://gist.github.com/hynek/ba655c8756924a5febc5285c712a7946
"""
